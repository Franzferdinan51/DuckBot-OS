...
try:
    from ..agents.vibevoice_commands import VibeVoiceCommands
...
try:
    from ..core.cost_management import CostCommands, CostTracker
...
try:
    from ..integrations.livekit_integration import LiveKitIntegration, LiveKitCommands
...
try:
    ...
    logger.info("Mining manager available")
except ImportError as e:
    logger.warning(f"Mining manager not available: {e}")
    MiningManager = None
    MiningSoftware = None

try:
    from ..agents.mining_commands import MiningCommands
    MINING_COMMANDS_AVAILABLE = True
    logger.info("Mining commands available")
except ImportError as e:
    logger.warning(f"Mining commands not available: {e}")
    MiningCommands = None
...
class DiscordBot:
    ...
    def __init__(self):
        ...
        self.mining_manager = MiningManager(cost_tracker=self.cost_tracker) if MINING_MANAGER_AVAILABLE else None
