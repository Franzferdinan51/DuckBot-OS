...
class Pipe:
    class Valves(BaseModel):
        ...
        FREE_ONLY: bool = Field(
            default=True,  # Default to True for DuckBot free setup
    ...
    def pipe(self, body: dict) -> Union[str, Generator, Iterator]:
        ...
        try:
            ...
            headers = {
                ...
                "HTTP-Referer": body.get("http_referer", "https://duckbot-ai.local/"),
                "X-Title": body.get("x_title", "DuckBot AI via OpenWebUI"),
            }
