...
try:
    ...
    print("VibeVoice modules not available - creating mock test")
...
class VibeVoiceSystemTester:
    ...
    async def test_configuration_loading(self):
        ...
        try:
            ...
            if config_path.exists():
                ...
                self._add_result("Configuration File", "WARNING", "Config file not found")
    ...
    async def run_all_tests(self):
        ...
        partial = len([r for r in self.test_results if "PARTIAL" in r["status"]])
