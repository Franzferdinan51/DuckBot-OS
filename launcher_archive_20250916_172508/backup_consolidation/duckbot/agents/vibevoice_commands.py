...
from ..integrations.vibevoice_client import VibeVoiceManager
...
class VibeVoiceCommands(commands.Cog):
    ...
    async def vibevoice_command(self, 
        ...
        try:
            ...
            if not self.vibevoice.is_available():
                embed = discord.Embed(
                    title="[NO] VibeVoice Unavailable",
            ...
            embed = discord.Embed(
                title="[EMOJI] VibeVoice Generation",
    ...
    async def voice_presets_command(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            title="[EMOJI] VibeVoice Presets & Voices",
    ...
    async def voice_status_command(self, interaction: discord.Interaction):
        ...
        try:
            ...
            embed.add_field(
                name="Service Status",
                value="[EMOJI] Available" if is_available else "[EMOJI] Unavailable",
                inline=True
            )
            ...
            embed.add_field(
                name="Configuration",
                value="[EMOJI] Enabled" if enabled else "[EMOJI] Disabled",
                inline=True
            )
            ...
            if is_available:
                ...
                async with self.vibevoice.client:
                    ...
                    embed.add_field(
                        ...
                        value="[EMOJI] Connected" if connected else "[EMOJI] Failed",
                        inline=True
                    )
    ...
    async def voice_help_command(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            title="[EMOJI] VibeVoice TTS Guide",
            description="Complete guide to multi-speaker text-to-speech",
            color=discord.Color.green()
        )
        
        embed.add_field(
            name="[EMOJI] Main Command: /vibevoice",
            value=(
